		...
		private void insertFileButton_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				else
				{
					...
					if (((endOff >> 14) & 0xFF) != ((offsetPos >> 14) & 0xFF)) insertionMessage += Environment.NewLine + "Note: This file may cross over the boundary of the offset's bank." + Environment.NewLine;
